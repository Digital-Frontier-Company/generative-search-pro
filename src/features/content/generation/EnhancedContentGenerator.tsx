...
import { sanitizeGeneratedHtml, sanitizeToPlainText } from '@/lib/htmlSanitizer';
...
${sanitizeToPlainText(generatedContent.content)}
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="prose max-w-none">
                        <div dangerouslySetInnerHTML={{ __html: sanitizeGeneratedHtml(generatedContent.htmlContent) }} />
                      </div>
                    </CardContent>
                  </Card>
                </div>
