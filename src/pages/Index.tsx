...
const Index = () => {
  ...
  const pricingPlans = [{
    ...
    features: ["Everything in Pro", "Team collaboration features", "White-label exports", "API access", "Priority support", "Custom integrations"],
    cta: "Start Free Trial",
    ctaAction: () => navigate('/auth', {
      state: {
        signUp: true
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Button size="lg" variant="outline" className="border-matrix-green text-matrix-green hover:bg-matrix-green/10 hover:border-matrix-lime text-lg px-8 py-4">
                See Live Demo
              </Button>
            </div>
      ...
      <section className="py-16 bg-matrix-dark-gray">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((testimonial, index) => <div key={index} className="content-card p-6">
                <div className="flex mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => <Star key={i} className="w-5 h-5 text-matrix-green fill-current" />)}
                </div>
      ...
      <section id="features" className="py-16 bg-black">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {featureBlocks.map((feature, index) => <div key={index} className="content-card p-6 hover:scale-[1.02] transition-all">
        ...
        <div className="container mx-auto px-4">
          <div className="content-card rounded-lg backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto pb-16">
              {pricingPlans.map((plan, index) => <div key={index} className={`content-card p-8 ${plan.highlighted ? 'neon-border ring-1 ring-matrix-green/50 scale-105' : ''}`}>
                  {plan.highlighted && <div className="bg-gradient-to-r from-matrix-green to-matrix-lime text-black text-xs font-medium py-1 px-3 rounded-full inline-block mb-4">
                      Most Popular
                    </div>}
                  ...
                  <div className="mt-4 mb-6">
                    ...
                    {plan.annualPrice && <div className="text-sm text-matrix-lime mt-1">
                  ...
                  <Button onClick={plan.ctaAction} className={plan.highlighted ? "w-full glow-button text-black font-semibold" : "w-full border-matrix-green text-matrix-green hover:bg-matrix-green/10"} variant={plan.highlighted ? "default" : "outline"}>
                    {plan.cta}
                  </Button>
                </div>)}
            </div>
      ...
      <section id="examples" className="py-16 bg-matrix-dark-gray">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            metric: "↑ 340% snippet visibility",
            industry: "E-commerce"
          }, {
            title: "How to Start a Podcast",
            metric: "↑ 280% voice search traffic",
            industry: "Education"
          }, {
            title: "Top Tourist Attractions in Paris",
            metric: "↑ 450% AI answer appearances",
            industry: "Travel"
          }].map((example, index) => <div key={index} className="content-card p-6 hover:scale-[1.02] transition-all cursor-pointer">
            ...
            <div className="divide-y border-t border-b border-matrix-green/30">
              {faqs.map((faq, index) => <div key={index} className="py-5">
                  <button onClick={() => setFaqOpen(faqOpen === index ? null : index)} className="flex justify-between items-center w-full text-left">
                    ...
                    {faqOpen === index ? <ChevronUp className="h-5 w-5 text-matrix-green" /> : <ChevronDown className="h-5 w-5 text-matrix-green" />}
                  </button>
                  {faqOpen === index && <div className="mt-3">
      ...
      <section className="py-16 bg-gradient-to-r from-matrix-green to-matrix-lime text-black">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-black text-black hover:bg-black/10 text-lg px-8 py-4">
              Schedule Demo
            </Button>
          </div>
