...
import { 
  CheckCircle, ArrowRight, Zap, Database, Globe, Sparkles, ChevronDown, ChevronUp 
} from "lucide-react";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" onClick={() => navigate('/auth', { state: { signUp: true } })} className="bg-aeo-blue hover:bg-aeo-blue/90">
                Get Started Free
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="content-card p-6 text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Export & Implement</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <div 
                key={index} 
                className={`content-card p-8 ${plan.highlighted ? 'border-aeo-blue/30 ring-1 ring-aeo-blue/20' : ''}`}
              >
                {plan.highlighted && (
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-aeo-blue to-aeo-purple text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button 
            ...
            className="bg-white text-aeo-blue hover:bg-gray-100"
          >
            Get Started Free
            <ArrowRight className="ml-2 h-5 w-5" />
          </Button>
