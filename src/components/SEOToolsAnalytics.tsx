...
const SEOToolsAnalytics = () => {
  ...
  return <Card className="content-card">
      <CardHeader>
        <CardTitle className="text-matrix-green flex items-center font-extrabold text-lime-400">
          <BarChart3 className="w-5 h-5 mr-2" />
          SEO Tools & Analytics
        </CardTitle>
        <CardDescription className="font-bold text-lime-300">
        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {analyticsData.trends.map((trend, index) => <div key={index} className="flex items-center justify-between p-2 bg-secondary/30 rounded">
          ...
          <TabsContent value="performance" className="space-y-4">
            <div className="space-y-2">
              ...
              {analyticsData.topPages.map((page, index) => <div key={index} className="p-3 bg-secondary/50 rounded-lg">
          ...
          <TabsContent value="keywords" className="space-y-4">
            <div className="space-y-2">
              ...
              {analyticsData.keywords.map((keyword, index) => <div key={index} className="flex items-center justify-between p-3 bg-secondary/50 rounded-lg">
                  <div>
                  ...
                  <Badge variant={keyword.position <= 5 ? "default" : keyword.position <= 10 ? "secondary" : "outline"} className="text-xs">
                    #{keyword.position}
                  </Badge>
                </div>)}
            </div>
